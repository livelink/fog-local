...
Gem::Specification.new do |spec|
  ...
  spec.authors       = ["Wesley Beary", "Ville Lautanala", "Geoff Youngs", "Cinti Puddu"]
  spec.email         = ["geemus@gmail.com", "lautis@gmail.com", "g.youngs@livelinktechnology.net", "c.puddu@livelinktechnology.net"]
